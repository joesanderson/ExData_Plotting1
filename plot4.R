...
png("plot4.png")
par(mfrow=c(2,2))
plot(corrected_data$trueDate,corrected_data$Global_active_power,type="l",ylab="Global Active Power",xlab="")
plot(corrected_data$trueDate,corrected_data$Voltage,type="l",ylab="Voltage",xlab="datetime")
...
plot(corrected_data$trueDate,corrected_data$Global_reactive_power,type="l",ylab="global_reactive_power",xlab="datetime")
dev.off()